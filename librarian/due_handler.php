	...
	<?php
		...
		if($rows > 0)
		{
			...
			for($i=0; $i<$rows; $i++)
			{
				...
				$to = $row[1];
				$message = "Este es un recordatorio de devolución del Automóvil '".$row[3]."' con la placa ".$row[2]." al concecionario.";
			...
			if($successfulEmails > 0)
				echo "<h2 align='center'>".$successfulEmails." Cliente exitosamente notificado</h2>";
			else
				echo "ERROR: No se pudo notificar a ningún cliente.";
		}
		else
